...
const FOOD_DEFS = [
  ...
  { id:'bread',   name:'面包',     emoji:'🍞', price:25,  effect:{hunger:15, mood:2},         desc:'饱腹+15 心情+2' },
  { id:'peanut',  name:'坚果',     emoji:'🥜', price:20,  effect:{hunger:10, mood:3},         desc:'饱腹+10 心情+3' },
  { id:'vegetable',name:'青菜',    emoji:'🥬', price:15,  effect:{hunger:12, mood:2},         desc:'饱腹+12 心情+2' },
